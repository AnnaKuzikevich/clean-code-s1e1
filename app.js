...
var incompleteTaskHolder=document.querySelector(".todo__ul");//ul of #incompleteTasks
...
var createNewTaskElement=function(taskString){
    ...
    listItem.className='todo-li task__li_init';
    ...
    checkBox.className='checkbox todo__check';
    editInput.type="text";
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("task__li_edit-mode");
    ...
    listItem.classList.toggle("task__li_edit-mode");
};
